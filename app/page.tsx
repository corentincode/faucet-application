...
import { FaucetForm, balanceUpdateEvent } from "@/components/faucet-form";
    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-4 md:p-8 bg-gradient-to-b from-background to-background/80 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <div className="p-8 space-y-8 relative z-10">
            <div className="text-center">
              ...
              <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">Token Faucet</h1>
              <p className="text-muted-foreground mt-2">Request test tokens for development</p>
            </div>
        ...
        <footer className="mt-8 text-center text-sm text-muted-foreground">
          <p>© 2025 Corentin Adelé. All rights reserved.</p>
        </footer>
      </div>
    </main>
  );
